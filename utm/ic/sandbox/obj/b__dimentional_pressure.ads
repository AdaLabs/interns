...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_dimentional_pressure" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6bf376e3#;
   pragma Export (C, u00001, "dimentional_pressureB");
