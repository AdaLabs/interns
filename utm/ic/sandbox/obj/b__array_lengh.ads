...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_array_lengh" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2a8cefd8#;
   pragma Export (C, u00001, "array_lenghB");
   ...
   u00115 : constant Version_32 := 16#6186175a#;
