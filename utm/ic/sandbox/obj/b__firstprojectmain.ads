...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_firstprojectmain" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5eb36e19#;
   pragma Export (C, u00001, "firstprojectmainB");
   ...
   u00118 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00118, "system__val_intB");
   u00119 : constant Version_32 := 16#2b83eab5#;
   pragma Export (C, u00119, "system__val_intS");
   u00120 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00120, "system__val_unsB");
   u00121 : constant Version_32 := 16#47085132#;
   pragma Export (C, u00121, "system__val_unsS");
   u00122 : constant Version_32 := 16#a6359005#;
   pragma Export (C, u00122, "system__memoryB");
   u00123 : constant Version_32 := 16#3a5ba6be#;
