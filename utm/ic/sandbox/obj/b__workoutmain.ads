...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_workoutmain" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1a017665#;
   pragma Export (C, u00001, "workoutmainB");
