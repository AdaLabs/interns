...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_palinedrome" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9f07fdf5#;
   pragma Export (C, u00001, "palinedromeB");
