--
--  Copyright (C) 2010-2014, SmartSide SAS
--
--        http://www.smart-side.com
--
----------------------------------------------------------------------
...
----------------------------------------------------------------------
--
--  2011/11/01, AdaLabs : Style conformance modicifcations.
--
...
package body Options_Analyzer is
   ...
   function Tail_Value (Default : String := "") return String is
      function Parameter_Tail (Pos : Positive) return String;
